"use strict";
// Sample 게시판만 파일목록을 보여준 후 선택하도록 하였고, 나머지는 extract-zip을 사용하여 모든 파일을 바로 풀도록 하였다.
...
async function fillList() {
    try {
        ...
        // Check if the selected template is "eGovFrame Web Template"
        if (selectedTemplate.label !== "New Web Project") {
            // Use extract-zip for all other templates
            ...
            // Continue with the existing method using yauzl for "eGovFrame Web Template"
...
function deactivate() { }
//# sourceMappingURL=generateProject%20copy.js.map